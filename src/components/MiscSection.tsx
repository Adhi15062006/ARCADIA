            ...
            >
              ...
              >
                <div className="relative aspect-[16/9] w-full">
                  ...
                  <img src={readingBlog.imageUrl} alt={readingBlog.title} referrerPolicy="no-referrer" className="w-full h-full object-cover" />
                ...
                <div className="p-8 max-h-[50vh] overflow-y-auto font-sans text-xs sm:text-sm text-gray-300 leading-relaxed space-y-4">
                  <div className="flex items-center gap-3 border-b border-white/5 pb-4 text-gray-500 font-mono text-[10px]">
                    ...
                    <span>•</span>
                    <span>Date: {new Date(readingBlog.createdAt).toLocaleDateString()}</span>
                  </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-3 text-xs text-gray-400">
                  ...
                  <div>
                    ...
                    <span>arcadiadevelopers07@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
